...
class ApplicationEntityTest {
    ...
    void gettersAndSetters() {
        ...
        service.setCreatedDate(LocalDateTime.of(2024, Month.JANUARY, 1, 0, 0));
        service.setLastUpdate(LocalDateTime.of(2024, Month.JUNE, 15, 12, 30));
    ...
    void constructorWithParameters() {
        ...
        LocalDateTime createdDate = LocalDateTime.of(2024, Month.JANUARY, 1, 0, 0);
        LocalDateTime lastUpdate = LocalDateTime.of(2024, Month.JUNE, 15, 12, 30);
        ...
        service.setLastUpdate(lastUpdate);
        ...
        assertTrue(service.isActive());
        assertEquals(createdDate, service.getCreatedDate());
        assertEquals(lastUpdate, service.getLastUpdate());
    }
    ...
    void toStringContainsAllFields() {
        ...
        assertTrue(toString.contains(createdDate.toString()));
        assertTrue(toString.contains(lastUpdate.toString()));
    }
    ...
    void constructor() {
        ...
        actualApplicationEntity.setCreatedDate(LocalDateTime.of(2024, Month.JANUARY, 1, 0, 0));
        actualApplicationEntity.setLastUpdate(LocalDateTime.of(2024, Month.JUNE, 15, 12, 30));
        ...
        assertEquals(LocalDateTime.of(2024, Month.JANUARY, 1, 0, 0), actualApplicationEntity.getCreatedDate());
        assertEquals(LocalDateTime.of(2024, Month.JUNE, 15, 12, 30), actualApplicationEntity.getLastUpdate());
        assertEquals("ServiceEntity{id=849a7d96-5fda-413c-9926-41f660078e76, name='Name'," + " codeName='NNM'," +
                ...
                " active=true, applicationRoleUser=null, createdDate=2024-01-01T00:00, lastUpdate=2024-06-15T12:30}", actualToStringResult);
    }
}
