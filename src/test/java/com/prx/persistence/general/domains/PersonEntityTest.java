...
class PersonEntityTest {
    ...
    void gettersAndSetters() {
        ...
        personEntity.setId("673bc2e0-15d9-47ca-b0dc-b98673089cec");
     ...
     *   <li>{@link PersonEntity#setId(String)}
    ...
    void testConstructor() {
        ...
        assertEquals("42", actualPersonEntity.getId());
        ...
        assertEquals("PersonEntity{id=42, name='Name', middleName='Middle Name', lastName='Doe', gender='Gender',"
