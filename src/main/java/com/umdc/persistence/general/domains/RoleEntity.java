...
@Table(name = ConstantPersistenceApp.ROLE_TABLE_NAME, schema = ConstantPersistenceApp.SCHEMA_NAME,
        uniqueConstraints = @UniqueConstraint(name = "uq_role_name_application", columnNames = {"name", "application_id"}))
public class RoleEntity implements Serializable {
    ...
    /**
     * Gets the application this role belongs to.
     *
    ...
    /**
     * Sets the application this role belongs to.
     *
     * @param application the application this role belongs to.
     */
